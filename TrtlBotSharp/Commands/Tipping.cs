...
namespace TrtlBotSharp
{
    public partial class Commands : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task WithdrawAsync(string Amount, [Remainder]string Remainder = "")
        {
            ...
            {
                await ReplyAsync(string.Format("Amount must be at least {0:n8} {1}", TrtlBotSharp.Minimum/*Fee*/, TrtlBotSharp.coinSymbol));
                return;
            }
            ...
            {
                await Context.Message.Author.SendMessageAsync(string.Format("Your balance is too low! Amount + Fee = **{0:n8}** {1}",
        ...
        public async Task BalanceAsync([Remainder]string Remainder = "")
        {
            ...
            else
            {
                ...
                // Send reply
                await Context.Message.Author.SendMessageAsync(string.Format("You have **{0:n8}** {1} in your tip jar", Balance, TrtlBotSharp.coinSymbol));
            }
        }
