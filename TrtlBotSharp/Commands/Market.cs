...
namespace TrtlBotSharp
{
    public partial class Commands : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task PriceAsync([Remainder]string Remainder = "")
        {
            ...
            Response.WithTitle("current price of traaittPlatform: " + TrtlBotSharp.marketSource);
            ...
            Response.AddInlineField("Volume", string.Format("{0:n8} BTC", (decimal)CoinPrice["volume"]));
